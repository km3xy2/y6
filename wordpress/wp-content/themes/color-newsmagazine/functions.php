...
if ( ! function_exists( 'color_newsmagazine_setup' ) ) :
	...
	function color_newsmagazine_setup() {
		...
		add_image_size( 'color-newsmagazine-thumbnail-1', 650, 434, true ); 

		// news verticle slider main.
		add_image_size( 'color-newsmagazine-thumbnail-4', 730, 487, true );
		
		// blog single column.
		add_image_size( 'color-newsmagazine-singlecolumn', 950, 475, true );
		// News Layout 4 .
		add_image_size( 'color-newsmagazine-thumbnail-5', 625, 400, true );

		// 5 sub image size.
		add_image_size( 'color-newsmagazine-thumbnail-7', 112, 75, true );

		// News Layout 8, content-list, layout 7 main.
		add_image_size( 'color-newsmagazine-thumbnail-8', 425, 283, true );

		// News Layout 10.
		add_image_size( 'color-newsmagazine-thumbnail-10', 664, 530, true );

		// News layout 2 sub image, layout 9 , news layout 7 sub image and footer news.
		add_image_size( 'color-newsmagazine-thumbnail-12', 122, 122, true );
		
		// main news right image.
		add_image_size( 'color-newsmagazine-thumbnail-rightnews', 430, 287, true );
