		...
		<?php dynamic_sidebar( 'advertisement_bar-'.get_theme_mod('color_newsmagazine_mainnews_google','0') ); ?>
			...
			<!-- Header left News -->
									...
									<div class=" single-slider 
										...
										<div class="slider-content ">
											<div class="slider-text cat">
												<?php if(get_theme_mod('color_newsmagazine_mainnews_upperslider_taxonomy_category','1')==1):
													the_category();
												endif ?>
											</div>
											<div class="slider-text meta shadow_bbc 
												...
												<?php if(get_theme_mod('color_newsmagazine_mainnews_upperslider_taxonomy_Title','1')==1): ?>
												<h3 class="mb-3"><a href="<?php the_permalink();?>"><?php the_title();?></a></h3>
												<?php endif ?>
												<div class="meta">
												<?php if(get_theme_mod('color_newsmagazine_mainnews_upperslider_taxonomy_author','1')==1): ?>
													<span class="author">
												...
												if(get_theme_mod('color_newsmagazine_mainnews_upperslider_taxonomy_date','1')==1): ?>
													<span class="date">
														<i class="fas fa-clock"></i>
														<?php color_newsmagazine_posted_on();?>
													</span>
												<?php endif;
												if(get_theme_mod('color_newsmagazine_mainnews_upperslider_taxonomy_comments','1')==1): ?>
													<span class="date"><i class="fas fa-comments"></i><?php color_newsmagazine_post_comment();?></span>
												<?php endif;
				...
				<?php if (get_theme_mod('color_newsmagazine_rightnews_enable','1') == 1 ): ?>
					<div class="position-initial mb-5 col-lg-3 col-md-12">
						<div >
							<h2 class="cat-title">
