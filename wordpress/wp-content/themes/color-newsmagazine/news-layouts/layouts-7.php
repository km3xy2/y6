...
if(get_theme_mod('color_newsmagazine_block_7_enable','1') == 1):
	...
	function color_newsmagazine_block_7_enable() {
		...
		?>
		<!-- News BIg -->
		<section class="<?php if ($title == Null )  { echo 'pt-5' ;} ?> news-big section off-white" >
			<div class="container">
				<?php
				$arguments = array(
								...
								if( $count == 0 ) :
									...
									<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
										...
										<div class="single-news main ">
											<div class="news-head mt-4 mb-4 ">
												<?php if( has_post_thumbnail() ) :
													the_post_thumbnail('color-newsmagazine-thumbnail-8');
												elseif (! has_post_thumbnail()): ?>
													<img src = "<?php echo esc_url( get_template_directory_uri() ); ?>/inc/images/425_283_lay7.png " >
												<?php endif;?>
											</div>
