	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<div class=" single-news media  news-style1 category blog-list">
			...
			<?php elseif (! has_post_thumbnail()): ?>
				<div class="news-head">
					<img src = "<?php echo esc_url( get_template_directory_uri() ); ?>/inc/images/content_list.png " >
				</div>
			<?php endif; 
			?>
			<div class="content media-body">
				...
				<?php if (! (is_archive() or is_search() )) {
					if(get_theme_mod('color_newsmagazine_readmore_enable','1')==1): ?>
						<div class = "pt-4" >
							<?php color_newsmagazine_modal();
							get_template_part('inc/social-share-modal'); ?>
						</div>
					<?php endif;
				} ?>
			</div>
